...
(function () {
  ...
  if (typeof window.Elf === 'undefined') {
      global.window.Elf = {};//create window.Elf root if not existed
  }
  window.Elf.global = global;//add a pointer to window
})();
...
var AppMsgHandlers = {
  ...
  //后退2次事件返回
  "CmdGoBack": function (CmdGoBack) {
    webApp.WebCallApp(CmdGoBack);
  },
  //重新返回到界面(Realized)
  "MsgReBack": function () {
...
if (typeof window.Elf != "undefined") {
  window.Elf.AppCallWeb = (sn,result) => {
